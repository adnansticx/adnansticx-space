        ...
        <div className="hidden sm:block">
          <div className="flex justify-between items-center text-center py-6 border-t-2 border-gray-300/40">
            <span className="text-sm text-gray-400">
              @copyright 2025 Travery || Adnansticx
            </span>
            <div className="flex items-center justify-center gap-4 mb-4">
              <a href="https://www.instagram.com/adnansticx_/" target="_blank">
                <FaInstagram className="text-4xl" />
              </a>
              <a href="https://www.facebook.com/profile.php?id=61555203517412" target="_blank">
                <FaFacebook className="text-4xl" />
              </a>
              <a href="https://www.linkedin.com/in/adnansticx/" target="_blank">
